...
var story6 = "There was a young boy whose father, a farmer, had asked him to take their herd of sheep grazing every day.One day, the boy was extremely bored as he watched over the sheep and so he cried: “Wolf! Wolf!”On hearing his cries, the villagers rushed to help him chase the wolf away and safe the sheep. When they saw the grinning boy and realised he had cried wolf for his amusement, they scolded him and told him to not cry wolf! The next day, the boy cried out that the wolf was there. The villagers came, scolded him again, and left.Later that same day, a wolf came and terrorized the sheep.The boy cried, “Wolf! Wolf! Please help me.”But, the villagers assumed that he was pulling a silly prank again and did not come to his rescue. The sheep ran away and the boy cried.Moral of the storyDon’t lie or engage in foolish pranks, for no one will believe a liar even when he is telling the truth!"


function textSpeak1() {

    responsiveVoice.speak(story1);
}
function textSpeak2() {

    responsiveVoice.speak(story2);
}
function textSpeak3() {

    responsiveVoice.speak(story3);
}
function textSpeak4() {

    responsiveVoice.speak(story4);
}
function textSpeak5() {

    responsiveVoice.speak(story5);
}
function textSpeak6() {

    responsiveVoice.speak(story6);
}
